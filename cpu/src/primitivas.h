...
//todo:t_valor_variable	obtenerValorCompartida(t_nombre_compartida	variable);
//todo:t_valor_variable asignarValorCompartida(t_nombre_compartida	variable, t_valor_variable valor_variable);
t_puntero_instruccion irAlLabel(t_nombre_etiqueta etiqueta);
//todo:t_puntero_instruccion llamarFuncion(t_nombre_etiqueta etiqueta, t_posicion donde_retornar, t_puntero_instruccion linea_en_ejecuccion);
